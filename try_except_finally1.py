...
# which can detect an invalid input in the beginning, and prints out an error message: 'Please input integers only.'
...
def interact():
  while True:  # keep looping until user reach break statement
    ...
    finally:    # run finally regardless of whether the input was valid or not
